    ...
    return(        
        <>
            ...
            <table className="table table-bordered mt-4">
                <thead>                    
                    <tr>
                    <th rowspan={7} style={{width:"200px"}} className="text-center">
                        <img src={'http://localhost:8080/'+data?.profilephoto} style={{width:"200px"}} alt='Adhar Card' /><br/>
                        Profile Photo     
                    </th>
                        <th>User name</th>
                        <th>{data?.name}</th>                        
                        <th rowspan={7}>
                            <img src={'http://localhost:8080/'+data?.uidphoto} style={{width:"400px",height:"250px"}} alt='Adhar Card' /><br/>
                            Adhar Id     
                        </th>
                    </tr>
                    <tr>
